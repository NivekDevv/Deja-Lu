...
const DetailsPasLu = ({ route, navigation, props }) => {
  ...
  React.useEffect(() => {
    let { bookPasLuClicked } = route.params;
    setTitle(bookPasLuClicked.title);
    setCover(bookPasLuClicked.cover);
    setAuthor(bookPasLuClicked.author);
    setDescription(bookPasLuClicked.description);
    setBookId(bookPasLuClicked._id);
    setStatus(bookPasLuClicked.dejalu);
    console.log(bookPasLuClicked.dejalu, "<---- C MON ITEM");
  }, []);
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          >
            ...
            <Text style={{ ...FONTS.body4, color: "red" }}>Non</Text>
          </View>
          <LineDivider />
          <View
            style={{
  ...
  function renderBottomButton() {
    return (
      <View style={{ flex: 1, flexDirection: "row" }}>
        ...
        >
          <Text style={{ ...FONTS.h3, color: COLORS.white }}>Lu</Text>
        </TouchableOpacity>
      </View>
    );
  }
...
export default connect(mapStateToProps, null)(DetailsPasLu);
